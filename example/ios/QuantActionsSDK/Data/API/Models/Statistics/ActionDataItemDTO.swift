struct ActionDataItemDTO: Decodable {
    let index: String
    let tappingTimeInterval: Double
    let confidenceIntervalLow: Double
    let confidenceIntervalHigh: Double

    enum CodingKeys: String, CodingKey {
        case index
        case tappingTimeInterval = "tapping-time-interval"
        case confidenceIntervalLow = "ci-l"
        case confidenceIntervalHigh = "ci-h"
    }
}

extension ActionDataItemDTO: MappableToMetricOrTrendDBO {
